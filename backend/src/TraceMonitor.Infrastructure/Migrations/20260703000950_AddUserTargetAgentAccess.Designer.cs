...
namespace TraceMonitor.Infrastructure.Migrations
{
    ...
    [Migration("20260703000950_AddUserTargetAgentAccess")]
    partial class AddUserTargetAgentAccess
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TraceMonitor.Core.Models.Agent", b =>
                {
                    ...
                    b.Property<bool>("PathChangeAlertsEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Location = "Oficina",
                            Name = "Oficina",
                            PathChangeAlertsEnabled = true,
                            Provider = "Oficina"
                        });
                });

            modelBuilder.Entity("TraceMonitor.Core.Models.AiAnalysisReport", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
